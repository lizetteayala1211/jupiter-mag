      ...
      <Main color="black">
        <LottieSection>
          <div className="video-container">
            <video width="560" height="315" src="../videos/Jupiter_Issue5_Cover_04_web-edit.mp4" muted playsInline loop={true} data-autoplay="" autoPlay={true} ></video>
          </div>
        </LottieSection>
        <LogoSection>
