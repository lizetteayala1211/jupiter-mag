...
export function Article() {
  return (
    ...
    <h1 className="title large"> On Conflict </h1>
    <br/>
    <h4 className="title small"> by Hanif Abdurraqib </h4>
    <br/>
    <pre id="contribution" />
          <div
            style={{
          ...
          /> 
    <br/>
    <p className="Hanif-Abdurraqib-05">
    I do not recall a time when my mother disciplined me in public. I say &#34;public&#34; here, and black folks who grew up in a neighborhood with largely only other black folks know the divide between what is public and what is Public. In my neighborhood, everyone was someone&#39;s parent, even if they weren&#39;t a parent themselves, even if they were only four or five years older than the person they found themselves urgently needing to put in their place. If your elders weren&#39;t around, <i> someone&#39;s </i> were. And this is a different kind of public. The Intimate Public is not the same as The Expansive Public, where the act of getting someone together might fall upon the eyes and ears of those who couldn&#39;t translate it.
    <br/><br/>
    And so, in grocery stores, if I was acting a damn fool &#40;as I often did in grocery stores&#41;, grabbing things and pouting when I had to put them back, crashing a shopping cart into a display, being a reckless and overly desirous child, my mother would give me a look. The look was a placeholder, something that, yes, those who don&#39;t know a look as language couldn&#39;t translate even if they <i> did </i> know a look as language, but something I knew well. Something that said <i> ok, keep that shit up, but we gotta go back home sometime. </i> And that&#39;s all it took to straighten me out, instantly. 
    <br/><br/> 
    ...
    <br/><br/>
    But what I believe Morrison also knew is that this additionally affords us, as a people, the ability &#40;and I would say the <i> requirement </i>&#41; to be course-correctors in the face of those who simply cannot be trusted to adequately care for and grow the black brilliance they have in their orbit. The record label executives or book editors who just want to cash in on the momentum of an art-maker, even if that art-maker has shown a clear decline in vision, or passion, because to be at the whims of an industry who declares you a genius is to, at times, lose touch with the hunger that propelled you in the first place.
    <br/><br/>
    ...
    <br/><br/>
    To put this another way: There is an interview with Sade Adu in the 1988 issue of <i> Interview </i> that I love, because she takes aim at Prince in a way that is firm, but gentle, and also indicts herself. She mentions that she watches Prince closely, and admires his bravery. She goes on to say that he charges into everything, horns down, and the results are sometimes mixed. &#34;I think much of what he does is quite trashy and &#91;I&#93; don&#39;t like it at all,&#34; she adds, before returning to mentioning the kind of bravery she saw in him that she wished she held herself. 
    <br/><br/>
    I find this soft diss, if it can even be called that, beautiful, because it exists as a self-indictment as much as it does an admission of distaste. Yes, Sade was saying. <i> Prince produces too much music and I don&#39;t like most of it, but God, he&#39;s so fearless. I wish I had that in myself. I would do something different, perhaps better with it. </i>
    <br/><br/>
    And that, too, is the beauty of close looking. Of intimate critique. We get to say, <i> I love what you have. I close my eyes and I dream that what you have might be something I could have, but I do not have it. </i>
    <br/><br/>
    <i> I need you to use it better. </i>
    </p>
    {/* <pre id="article" />
          <div
            style={{
    ...
    <div style={{ display: "flex", flexDirection: "column", }}>
        <SignatureContainer src={HanifBio} alt="Hanif Abdurraqib by Kate Sweeney." className="bio-img" />
    </div>
    <br/>
