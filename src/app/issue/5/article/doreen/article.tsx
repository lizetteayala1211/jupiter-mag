...
export function Article() {
  return (
    ...
    <div style={{ display: "flex", flexDirection: "column" }}>
      <SignatureContainer src={Dry4} alt="Cauleen Smith, Drylongso, 1998, film still. Courtesy of the artist and Morán Morán." className="article-img enlarge" />
    </div>
    <br/>
    ...
    <br/><br/>
    <div style={{ display: "flex", flexDirection: "column" }}>
      <SignatureContainer src={Dry5} alt="Cauleen Smith, Drylongso, 1998, film still. Courtesy of the artist and Morán Morán." className="article-img enlarge" />
    </div>
    <br/>
    <span className="centered small"> Cauleen Smith, <i> Drylongso, </i> 1998, film still. Courtesy of the artist and Morán Morán. </span>
    <br/>
    ...
    <br/><br/>
    <div style={{ display: "flex", flexDirection: "column" }}>
      <SignatureContainer src={Dry1} alt="Cauleen Smith, Drylongso, 1998, film still. Courtesy of the artist and Morán Morán." className="article-img enlarge" />
    </div>
    <br/>
    <span className="centered small"> Cauleen Smith, <i> Drylongso, </i> 1998, film still. Courtesy of the artist and Morán Morán. </span>
    <br/>
    ...
    <br/><br/>
    <div style={{ display: "flex", flexDirection: "column" }}>
      <SignatureContainer src={Dry3} alt="Cauleen Smith, Drylongso, 1998, film still. Courtesy of the artist and Morán Morán." className="article-img enlarge" />
    </div>
    <br/>
    <span className="centered small"> Cauleen Smith, <i> Drylongso, </i> 1998, film still. Courtesy of the artist and Morán Morán. </span>
    <br/>
    ...
    <br/><br/>
    <div style={{ display: "flex", flexDirection: "column" }}>
      <SignatureContainer src={Dry2} alt="Cauleen Smith, Drylongso, 1998, film still. Courtesy of the artist and Morán Morán." className="article-img enlarge" />
    </div>
    <br/>
    <span className="centered small"> Cauleen Smith, <i> Drylongso, </i> 1998, film still. Courtesy of the artist and Morán Morán. </span>
    <br/>
