...
export function Article() {
  return (
    ...
    <a href="https://soundcloud.com/kemkemlij/afrobeatsroots?si=17394d3895a64589909d222800767ed0&utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing" target="_blank" className="styled"> <i> Old School Afrobeats Mix Kem Kem for Jupiter Magazine </i> </a> </span>
    {/* <br/>
    ...
    <br/><br/>
    This is where Wizkid may be said to have erred in his formulation. There is something to be said for an artist who expresses frustration at feeling they have outgrown the sounds of their genesis. However, in his distancing from the market-based, limiting language-game of Afrobeats, he distances himself from those who see it in terms of the expansive<sup><a href="#fn8" id="ref8">8</a></sup> and exciting language-game of Afrobeats. In the early 2000s, I remember seeing a young Wizkid and cherishing how he represented us youth in Nigeria, influenced by the sounds that we heard on Channel O and MTV Base, but informed by our surroundings. <i> That&#39;s </i> how Afrobeats began. Before a category, it just was and what it was, was <i> true. </i>
    <br/><br/>
    ...
    <pre id="article" />
          ...
          />
    <span className="footnotes olukemi">
    <p className="footnotes-p">
    <ol className="footnotes-ol">
        <li className="footnotes-li" id="fn1"> Paul Gilroy, <i> The Black Atlantic: Modernity and Double Consciousness </i> &#40;London and New York: Verso, 1993&#41;, 15, quoted in Adiva Lawrence, &#34;Afro Modern: Journeys Through the Black Atlantic,&#34; <i> Afterall ArtSchool: Black Atlantic Museum, </i> 2023. Accessed February 7, 2025. <a href="#ref1">↩</a></li> <br/>
        <li className="footnotes-li" id="fn2"> Writer &#40;and my cousin&#41; Danielle Agbor reminded me of the fact that there is a trend of artists having spirited outbursts following the passing of their mothers. Let&#39;s remember two controversies: Kanye West&#39;s &#34;Imma let you finish&#34; at the VMAs in 2009 and writer Chimamanda Ngozi Adichie&#39;s 2021 <a href="https://www.chimamanda.com/news_items/it-is-obscene-a-true-reflection-in-three-parts/" target="_blank" className="styledli"> treatise, </a> both outbursts in the wake of losing their mothers. 
        <a href="#ref2">↩</a></li> <br/>
        <li className="footnotes-li" id="fn3"> This is a term coined by contemporary rap musician Brazy. <a href="#ref3">↩</a></li> <br/>
        <li className="footnotes-li" id="fn4"> Dotun Ayobade, &#34;Introduction: Afrobeats&#39; Lower Frequencies,&#34; The Black Scholar 54, no. 3 &#40;2024&#41;: 1&#175;10, <a href="https://doi.org/10.1080/00064246.2024.2370204" target="_blank" className="styledli"> https://doi.org/10.1080/00064246.2024.2370204. </a> <a href="#ref4">↩</a></li> <br/>
        <li className="footnotes-li" id="fn5"> Kevin Gaines, &#34;Duke Ellington, <i> Black, Brown and Beige, </i> and the Cultural Politics of Race,&#34; <i> Music and the Racial Imagination </i> &#40;Chicago: University of Chicago Press, 2000&#41;. <a href="#ref5">↩</a></li> <br/>
        <li className="footnotes-li" id="fn6"> <i> Miles Ahead, </i> directed by Don Cheadle &#40;Sony Pictures Classics, 2015&#41;, 1:40:00. <a href="#ref6">↩</a></li> <br/>
        <li className="footnotes-li" id="fn7"> Ijapa is the name of a mischievous tortoise, a central character in popular Yoruba folktales told to children, and told to me by my grandmother. <a href="#ref7">↩</a></li> <br/>
        <li className="footnotes-li" id="fn8"> Rema encapsulates this perspective wonderfully in an interview with MTV at the 2025 Grammys: <a href="https://x.com/hypetribeng/status/1886209943956500662" target="_blank" className="styledli"> https://x.com/hypetribeng/status/1886209943956500662. </a> <a href="#ref8">↩</a></li> <br/>
        <li className="footnotes-li" id="fn9"> Dave Laing&#39;s interesting market-based analysis of genre &#40;2009&#41; as discussed in: Genevieve Allotey-Pappoe, &#34;Genre or Hypernym: Deconstructing Afrobeats in the Global Music Industry,&#34; <i> Journal of Popular Music Studies 36, </i> no. 4 &#40;2024&#41;: 25&#175;39,. <a href="https://doi.org/10.1525/jpms.2024.36.4.25" target="_blank" className="styledli"> https://doi.org/10.1525/jpms.2024.36.4.25. </a> <a href="#ref9">↩</a></li> <br/>
        <li className="footnotes-li" id="fn10"> <i> What is Afrobeats? </i> is a <a href="https://soundcloud.com/kemkemlij/afrobeatsroots?si=17394d3895a64589909d222800767ed0&utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing" target="_blank" className="styledli"> mix </a> curated by me under my DJ moniker Kem Kem, far from exhaustive it is an audio sketch of the genre&#39;s origins/old school Afrobeats that emerged in the early 2000s. In this mix, I set it off with Wizkid&#39;s &#34;Oluwa Lo Ni,&#34; released in 2011 on his debut album. This first song is a hybrid English/Yoruba song clearly influenced by US West Coast hip hop groups from the skinny jeans era such as the New Boyz and Cali Swag District. An illustrative track, it exemplifies the sonic integration of influences as Wizkid narrates his burgeoning career which began in Ojuelegba, Lagos. Symbolically, the mix concludes with the elusive Blackmagic&#39;s &#34;Repete&#34; &#40;2013&#41;. Many thanks to those who responded to a question on my Instagram story asking what songs define Afrobeats for them, much of those contributions populate this mix. <a href="#ref10">↩</a></li> <br/>
    </ol>
    </p>
    </span>
