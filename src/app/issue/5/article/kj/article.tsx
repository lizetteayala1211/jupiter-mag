...
import Ima from "../../../../../../public/photos/Ima.jpg"
import Diedrick from "../../../../../../public/photos/Diedrick.jpg"
import Kameelah from "../../../../../../public/photos/Kameelah.png"
import Rahima from "../../../../../../public/photos/Rahima.png"
import Roy from "../../../../../../public/photos/Roy.jpg"
...
export function Article() {
  return (
    ...
    <h1 className="title large"> Submitting to the Cry from the Abyss: Opacity, Exorbitance, and a Brief Exercise in the Erotics of Decipherment </h1>
    <br/>
    <h4 className="title small"> by KJ Abudu </h4>
    <br/>
    <pre id="contribution" />
          <div
            style={{
          ...
          /> <a href="" target="_blank" className="styledli">  </a> 
    <br/>
    <p className="KJ-Abudu-05">
    ...
    <pre id="article" />
          ...
          /> 
    <span className="footnotes kj">
    <p className="footnotes-p">
    <ol className="footnotes-ol">
        <li className="footnotes-li" id="fn1"> Adi, Kobby. <i> Cloisters. </i> 16mm black and white and color film, 155.7 feet, silent. 2023-24. </li> <br/>
        <li className="footnotes-li" id="fn2"> Bradley, Rizvana. <i> Anteaesthetics: Black Aesthesis and the Critique of Form. </i> Stanford: Stanford University Press, 2023. </li> <br/>
        <li className="footnotes-li" id="fn3"> Carter, J. Kameron, <i> The Anarchy of Black Religion: A Mystic Song. </i> Durham and London: Duke University Press, 2023. </li> <br/>
        <li className="footnotes-li" id="fn4"> Cervenak, Sarah Jane. <i> Black Gathering: Art, Ecology, Ungiven Life. </i> Durham and London: Duke University Press, 2021. </li> <br/>
        <li className="footnotes-li" id="fn5"> Chandler, Nahum Dimitri. <i> X—The Problem of the Negro as a Problem for Thought. </i> New York: Fordham University Press, American Literatures Initiative, 2013. </li> <br/>
        <li className="footnotes-li" id="fn6"> Chigumadzi, Panashe. <a href="https://africasacountry.com/2021/10/the-cry-of-black-worldlessness" target="_blank" className="styledli"> &#34;The cry of Black worldlessness.&#34; </a> <i> Africa Is a Country, </i> 2021. </li> <br/>
        <li className="footnotes-li" id="fn7"> Crawley, Ashon T. <i> The Lonely Letters. </i> Durham and London: Duke University Press, 2020. </li> <br/>
        <li className="footnotes-li" id="fn8"> da Silva, Denise Ferreira. <a href="https://www.e-flux.com/journal/79/94686/1-life-0-blackness-or-on-matter-beyond-the-equation-of-value/" target="_blank" className="styledli"> &#34;1 &#40;life&#41; &#247; 0 &#40;blackness&#41; = &#8734; &#175; &#8734; or &#8734; / &#8734; </a> : On Matter Beyond the Equation of Value.&#34; <i> e-flux Journal Issue &#35;79, </i> 2017. </li> <br/>
        <li className="footnotes-li" id="fn9"> Dennis, Nolan Oswald. <i> no conciliation is possible &#40;working diagram&#41;. </i> Center for Contemporary Arts, Berlin, Germany, 2022. </li> <br/>
        <li className="footnotes-li" id="fn10"> Derrida, Jacques. <i> Of Grammatology, </i> trans. Gayatri Chakravorty Spivak. Baltimore: Johns Hopkins University Press, 1976. </li> <br/>
        <li className="footnotes-li" id="fn11"> Fanon, Frantz. <i> The Wretched of the Earth, trans. Richard Philcox. </i> New York: Grove Press, 2021. </li> <br/>
        <li className="footnotes-li" id="fn12"> Glissant, Édouard. <i> Poetics of Relation, trans. Betsy Wing. </i> Ann Arbor: The University of Michigan Press, 1997. </li> <br/>
        <li className="footnotes-li" id="fn13"> Harney, Stefano and Fred Moten. <i> All Incomplete. </i> Colchester, New York, and Port Watson: Minor Compositions, 2021. </li> <br/>
        <li className="footnotes-li" id="fn14"> Hartman, Saidiya. <a href="https://bombmagazine.org/articles/2024/09/16/dionne-brand-by-saidiya-hartman/" target="_blank" className="styledli"> &#34;Dionne Brand by Saidiya Hartman.&#34; </a> <i> BOMB Magazine, </i> 2024. </li> <br/>
        <li className="footnotes-li" id="fn15"> Jackson, Zakiyyah Iman. <i> Becoming Human: Matter and Meaning in an Antiblack World. </i> New York: New York University Press, 2020. </li> <br/>
        <li className="footnotes-li" id="fn16"> James, Joy. &#34;The Womb of Western Theory: Trauma, Time Theft, and the Captive Maternal.&#34; In <i> Carceral Notebooks, </i> Vol. 12, 2016. </li> <br/>
        <li className="footnotes-li" id="fn17"> Judy, R.A. <i> Sentient Flesh: Thinking in Disorder, Poiēsis in Black. </i> Durham and London: Duke University Press, 2020. </li> <br/>
        <li className="footnotes-li" id="fn18"> Mbembe, Achille. <i> Critique of Black Reason. </i> Durham and London: Duke University Press, 2017. </li> <br/>
        <li className="footnotes-li" id="fn19"> McKittrick, Katherine and Alexander G. Weheliye. &#34;808s & Heartbreak,&#34; <i> Propter Nos, </i> 2:1, Fall 2017, 13-42. </li> <br/>
        <li className="footnotes-li" id="fn20"> Moten, Fred. <a href="https://www.youtube.com/watch?v=G2leiFByIIg" target="_blank" className="styledli"> &#34;Blackness and Nonperformance.&#34; </a> Lecture at Museum of Modern Art, 2015. </li> <br/>
        <li className="footnotes-li" id="fn21"> von Reinhold, Shola. <i> LOTE. </i> London: Jacaranda Books, 2020. </li> <br/>
        <li className="footnotes-li" id="fn22"> Robinson, Cedric J. <i> Black Marxism: The Making of the Black Radical Tradition. </i> Chapel Hill and London: The University of North Carolina Press, 2000. </li> <br/>
        <li className="footnotes-li" id="fn23"> Warren, Calvin L. &#34;The Catastrophe: Black Feminist Poethics, Anti&#40;form&#41;, and Mathematical Nihilism.&#34; <i> Qui Parle: Critical Humanities and Social Sciences, </i> Vol. 28, No. 2, December 2019, 353-372. </li> <br/>
        <li className="footnotes-li" id="fn24"> Wynter, Sylvia. <i> Black Metamorphosis: New Natives in a New World. </i> Unpublished Manuscript, 1970s. </li> <br/>
        <li className="footnotes-li" id="fn25"> Wynter, Sylvia. &#34;Unsettling the Coloniality of Being/Power/Truth/Freedom: Towards the Human, After Man, Its Overrepresentation—An Argument.&#34; The New Centennial Review, Vol. 3, No. 3, Fall 2003, 257-337. </li> <br/>
    </ol>
    </p>
    </span>
