...
export function Article() {
  return (
    ...
    <br/><br/>
    Further, Suzanne&#39;s role as a mother is represented minimally. In the same two-minute sequence where Zita claims Suzanne did not want to be remembered, she describes how motherhood challenged Suzanne&#39;s role as a writer. &#34;The work of writing was paramount to her &#91;Suzanne&#93;… It is difficult to be a productive writer when you have six children,&#34; she says, as her own newborn can be heard crying, before a nanny appears with the baby towed in a cradle. Zita&#39;s onscreen presence with her child offers a sort of bourgeois reenactment of motherhood, in stark contrast to both her remarks and Svoboda&#39;s narrativization of the difficulty motherhood posed to Suzanne. 
    <br/><br/>
    ...
    <div style={{ display: "flex", flexDirection: "column", }}>
        <SignatureContainer src={AmandineBio} alt="Yume Murphy by Stephanie Ayala." className="bio-img" />
    </div>
    <br/>
