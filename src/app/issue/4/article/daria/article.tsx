...
export function Article() {
  return (
    ...
    <br/><br/>
    My decision to begin our book club by reading <i>Parable of the Sower</i>  was an intentional one. It was many folks&#39; first time encountering this text, and felt especially salient in the midst of an especially unpredictable year for us all. The characters in <i> Parable </i> witness an authoritarian politician running for president, are forced to deal with the cataclysmic repercussions of climate change and environmental racism, and experience the severe weight of wealth gaps; all of which continue to resemble our reality. Yet, reading the book in that moment, especially as a collective, somehow felt like a salve. 
    <br/><br/>
    Within her texts, Butler summons worlds anew. Attuned to the patterns of history, she speaks of the future with a sense of clarity. Thus, making way for us to discover our own capacity to do the same. Butler&#39;s pages are full of characters grappling with their own self-possession and attuning themselves to their  purposes, both as individuals and as a community. Ignited by her unwavering prescience, Butler&#39;s writing offers a poignant lens through which we might cast forth our own visions for the horizons we wish to stretch into. 
    <br/><br/>
    <i> Soon, it became evident that to take heed of Butler&#39;s message also meant to answer her call.  </i>
    <br/><br/>
    ...
    <br/>
    Artist draws equally on Butler&#39;s personal life—a selection of her journal entries and drawings are also featured in the exhibition—as they do from subject matter and themes within the author&#39;s work. A spiked steel gate juts out from <i> Robledo Community Wall, </i> giving way to a view of <i> To Acorn &#40;1984&#41; </i> &#40;2022&#41;, a steel sculpture in the form of naming a bus stop, not unlike the posts where Butler would have waited on her travels throughout the sprawling city of Los Angeles. Butler never learned to drive, so her bus rides became a sacred time for her to write. 
    <br/><br/>
    At the base of the sculpture lies a grouping of firm steel leaves with their points stretched upwards, not unlike an agave plant that Butler surely encountered across the region. A slight curvature pulls the body of each leaf slightly away from the plant&#39;s core. Layered together, it&#39;s as if the small shrub has been frozen in the midst of a splendorous blossoming, opening up to the heavens while unyielding on earth. As Artist nods to this detail of Butler&#39;s life, they are also making a direct reference to Butler&#39;s text.
    <br/> <i> To Acorn </i> renders the utopic geography of Lauren&#39;s post-Robledo community as a tangible destination for Artist, for Butler, and perhaps for us too.
    <br/><br/>
    ...
    <br/><br/>
    Artist refers to their work as &#34;provocations,&#34; and in some cases prophecies. Over the last decade, their offerings have been born out of a set of questions aimed at subverting dominant narratives around race, technology, visibility, knowledge production, and consumption. Early works involved online performances, in which Artist thwarted algorithmic functions by posting coded information on social media and web platforms, often making use of different forms of redaction. In 2023, Artist mounted <i> Security Theater, </i> a site-specific installation consisting of a spherical black form hanging directly in the center of the Guggenheim Museum&#39;s famed rotunda. A thin silver ring wrapped around the object&#39;s diameter, its glossy surface reflecting the environment around it, while simultaneously concealing CCTV cameras in its core. Included in Ashley James&#39;s exhibition <i> Going Dark: The Contemporary Figure at the Edge of Visibility </i> &#40;2024&#41;, the installation extended into a room showing live surveillance of the inside of the museum. Entry into this section required visitors to lock their phones away in pouches to limit any documentation. Artist brought us face to face with a sort of collective performance of safety, and further, drew attention to our own participation in this spectacle, whether actively or passively. This work leaves me considering what pieces of ourselves—in the form of information, imagery, and beyond—are being taken from us, and which pieces we are unknowingly giving away. 
    <br/><br/>
