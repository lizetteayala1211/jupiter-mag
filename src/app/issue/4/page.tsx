...
function EditorsNoteCopy() {
  return (
    ...
    >
    <p>
    <span className="centered"> Octavia E. Butler&#39;s Parable of the Sower, published by Warner Books in 1995. Cover art by John Jude Palencar. </span>
    <br/><br/>
