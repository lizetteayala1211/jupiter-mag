...
function EditorsNoteCopy() {
  return (
    ...
    <br/><br/>
    To this end, we corroborate Mandy Harris Williams&#39;s essay <a href="http://hman.love/journal/critique-as-care" target="_blank" className="styled"> Critique as Care </a>,&#8221; in which she states: &#8220;Critique holds fascism as its enemy. … With social and political criticism out of the way, fascism is left to flourish.&#8221; We maintain that experimental arts writing and cultural criticism can serve as one wrench in the operations of those &#8220;would-be leaders&#8221; who abide by the logics that feed the mouth of extractionist paradigms. We hope this issue attunes you to the regard, civic responsibility, and mutual dependence from which both Harris Williams&#39;s and Butler&#39;s statements, and those found in each of these contributions, emerge. 
    </p>
    <br/><br/><br/><br/><br/><br/>
    </div>
  )
